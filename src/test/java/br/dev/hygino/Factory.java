...
public class Factory {
    static List<Book> bookListFactory() {
        List<Book> books = Arrays.asList(new Book("O Guarani", "José de Alencar", "Martins Fontes", 608, 1857, "Brasil"),
    ...
    static final List<Book> BrazilBookListFactory() {
        List<Book> books = List.of(new Book("O Guarani", "José de Alencar", "Martins Fontes", 608, 1857, "Brasil"),
                new Book("Dom Casmurro", "Machado de Assis", "Penguin Companhia", 256, 1899, "Brasil"),
                new Book("Grande Sertão: Veredas", "João Guimarães Rosa", "Nova Fronteira", 624, 1956, "Brasil"),
                new Book("O Cortiço", "Aluísio Azevedo", "Ateliê Editorial", 320, 1890, "Brasil"),
                new Book("Capitães da Areia", "Jorge Amado", "Companhia das Letras", 280, 1937, "Brasil"),
    ...
    static final List<String> listaAutoresBrasileiros() {
        return List.of(
                "Aluísio Azevedo",
                "Clarice Lispector",
                "Graciliano Ramos",
